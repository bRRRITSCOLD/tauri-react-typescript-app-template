...
export interface LogsTablePropsColumnInterface {
  id: string,
  label: string,
  minWidth?: number,
  align?: string;
...
export interface LogsTablePropsInterface {
  logAuditFiles: any[];
  onAddLogDirectoryClick: (event: any) => void;
}

export function LogsTable(props: LogsTablePropsInterface) {
  // deconstruct for ease
  const { logAuditFiles, onAddLogDirectoryClick } = props;
        ...
        <Paper className={classes.root}>
          <TableContainer className={classes.container}>
            <MUITable stickyHeader aria-label="sticky table">
              <TableHead>
                <TableRow>
                  {columns.map((column: LogsTablePropsColumnInterface) => (
                    <TableCell
                      key={column.id}
